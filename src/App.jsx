                ...
                {isLoaded && (
                  <motion.div initial={{ y: -200 }}
                    ...
                    {language === 'english' ? (
                      ...
                      <h2 className=' arabic-bold text-[25px] xl:text-[40px] mix-blend-screen opacity-[40%]'>عصر المغفل الليبي</h2>
                    )
                    }
                  </motion.div >
                )}
                ...
                {isLoaded && (
                  <motion.div initial={{ x: 850 }}
                    animate={{ x: 0 }} transition={{ duration: 0.8, delay: 1 }} className="overflow-y-hidden box-border" >
                    {
                      language === 'english' ? (
                        <p
                          className='copperplate lg:text-[10px] xl:text-[20px] mix-blend-screen opacity-[40%]'>from Grove to Gourmet</p>
                      ) : (
                        <p
                          className='arabic lg:text-[10px] xl:text-[20px] mix-blend-screen opacity-[40%]'>من البستان إلى الطهاة الراقين</p>
                      )
                    }
                  </motion.div>
                )}
              ...
              <AnimatePresence>
                {isLoaded && (
                  <motion.div
                    ...
                    <h3 className={language === 'arabic' ? 'arabic lg:text-[10px] xl:text-[20px] mix-blend-screen opacity-[40%]' : 'copperplate lg:text-[10px] xl:text-[20px] mix-blend-screen opacity-[40%]'}>
                      {language === 'english' ? (
                        <>
